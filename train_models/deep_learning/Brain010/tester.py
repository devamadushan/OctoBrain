...
sortie = data['result']
params = data['params']
path_input = data['path_formater_to_train']['data_input']

path_out = data['path_formater_to_train']['data_output']
...
def test_model_with_others_datas(path_brain_test,to_formate, save_formated, path_input_data, path_output_data):
